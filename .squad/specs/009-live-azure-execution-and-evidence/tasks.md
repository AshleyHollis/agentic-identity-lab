...
| T09 | Browser / agent-browser smoke execution | Mouse / Neo | T08 | Blocked / waiting: latest protected deploy failed during Entra bootstrap; smoke dispatch remains waiting for approval; they must still prove Graph/bootstrap permission, protected OBO credentials, and real delegated browser/agent-browser E2E |
...
| T14 | Deployment readiness review | Tank | T01-T08, T13 | In progress / blocked on the latest protected deploy failure during Entra bootstrap, smoke approval, then Graph/bootstrap proof, protected OBO credential setup, live browser/agent-browser E2E evidence, and shutdown verification for that run; not blocked on automating Entra MFA |
