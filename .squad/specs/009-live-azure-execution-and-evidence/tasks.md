...
| T09 | Browser / agent-browser smoke execution | Mouse / Neo | T08 | Blocked / waiting: protected deploy runs `25650318060`, `25651148137`, and `25651314772` failed in Entra bootstrap/apply stage; smoke runs `25651456852` and `25651495126` failed preflight due missing protected smoke secrets (`M9_PLAYWRIGHT_ACCESS_TOKEN` and `M9_AGENT_BROWSER_COMMAND`); real delegated browser/agent-browser E2E is still pending |
...
| T14 | Deployment readiness review | Tank | T01-T08, T13 | In progress / blocked on Entra bootstrap apply failures in protected deploy, missing protected smoke secrets for both browser transports, then live E2E proof and final review gates; not blocked on automating Entra MFA |
